if __name__ == '__main__':
    ...
    #columns from 16 to 293 is data preprocessing
    ...
    #same shops
    train.loc[train.shop_id == 0, 'shop_id'] = 57   # 0 and 57 are same
    test.loc[test.shop_id == 0, 'shop_id'] = 57     # 0 and 57 are same

    train.loc[train.shop_id == 1, 'shop_id'] = 58   # 1 and 58 are same
    test.loc[test.shop_id == 1, 'shop_id'] = 58     # 1 and 58 are same

    train.loc[train.shop_id == 40, 'shop_id'] = 39  # 39 and 40 are same
    test.loc[test.shop_id == 40, 'shop_id'] = 39    # 39 and 40 are same

    #Simple train dataset
    index_cols = ['shop_id', 'item_id', 'date_block_num']   #shop item date
    ...
    #Add month sales
    # ['date_block_num','shop_id','item_id'] group and sum
    ...
    #     'verbose': 1
    # }
    # step3:feature_fraction and bagging_fraction (0.87285)
    # params = {
    #     'objective': 'mse',
    #     'metric': 'rmse',
    #     'num_leaves': 150,
    #     'learning_rate': 0.005,
    #     'feature_fraction': 0.75, #colsample_bytree
    #     'bagging_fraction': 0.75, #subsample
    #     'bagging_freq': 5,
    #     'min_split_gain' : 0.02,
    #     'min_child_weight' : 40,
    #     'seed': 1,
